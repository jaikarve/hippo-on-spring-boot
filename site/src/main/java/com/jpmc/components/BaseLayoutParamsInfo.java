...
@FieldGroupList({
        @FieldGroup(
                titleKey = "header",
                value = { "title", "icon", "separatorMargin", "separatorBorderTop", "separatorBorderBottom", "offerBackgroundColor",
                            "borderColor"}
        )
})
...
public interface BaseLayoutParamsInfo {
    ...
    final static String PARAM_BORDER_COLOR = "borderColor";
    final static String OFFER_BACKGROUND_COLOR = "offerBackgroundColor";
    ...
    @Parameter(name = OFFER_BACKGROUND_COLOR, required = false)
    @Color
    String getOfferBackgroundColor();

    @Parameter(name = PARAM_BORDER_COLOR, defaultValue = "#F07230")
    @Color
